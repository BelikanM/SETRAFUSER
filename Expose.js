...
const ROOT_PATH = path.join(process.env.HOME, "SETRAFUSER");
...
app.get("/", (req, res) => {
  ...
  <head>
    <meta charset="UTF-8">
    <title>Gestionnaire Frontend</title>
  ...
  <body>
    <header>
      <h1><i class="fa-solid fa-folder-open"></i> Gestionnaire Frontend</h1>
    </header>
    <div class="container">
...
app.listen(PORT, () => console.log(`📂 Frontend accessible sur http://localhost:${PORT}`));
